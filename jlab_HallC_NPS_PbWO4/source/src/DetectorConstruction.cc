   ...
   fDetectorMessenger(0)
{
  ...
  fMom_pos_Y = 0*mm;
  fMom_theta = -NPS_angle*pi/180.;//20180417 -12*pi/180.;//20180417 changed from -8.93*pi/180.;//-15.*pi/180.;//-8.93*pi/180.;//-7.93*pi/180.;
...
void DetectorConstruction::DefineMaterials()
{
  ...
  fWorldMater = fVacuumMater;//its still vacuum!!
...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  fSingle_Z = fCrystal_Z + fPMT_Z + fWrapThickness/* pmtcover thickness*/ + fWrapThickness/* crystal wrapper thickness*/;
  ...
  new G4PVPlacement(0,
		    G4ThreeVector(-(0.5*43.8 - 7.8 - 0.5*21 - (-0.5*21.25 + 17.5) )*inch + fSweepingMagnetShift_X, (22.5 + (-0.5*14.875 + 3.62) )*inch + fSweepingMagnetShift_Y, (0.5*39.5 + 0.5*5.2)*inch + fSweepingMagnetShift_Z),//positioned relative to SweepingMagnet_1_2_1
  ...
  new G4PVPlacement(zRot,
		    G4ThreeVector(-(0.5*43.8 - 7.8 - 0.5*21 - (-0.5*21.25 + 17.5) )*inch + fSweepingMagnetShift_X, (-22.5 - (-0.5*14.875 + 3.62) )*inch + fSweepingMagnetShift_Y, (0.5*39.5 + 0.5*5.2)*inch + fSweepingMagnetShift_Z),//positioned relative to SweepingMagnet_1_2_2
		    fLogicSweepingMagnet_6_4,
