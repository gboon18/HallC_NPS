...
CrystalFrontCoverSD::CrystalFrontCoverSD(G4String name)
: G4VSensitiveDetector(name), fHitsCollection(0), fHCID(-1)
{
    collectionName.insert("CrystalFrontCoverColl");
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

CrystalFrontCoverSD::~CrystalFrontCoverSD()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void CrystalFrontCoverSD::Initialize(G4HCofThisEvent* hce)
{
  fHitsCollection 
    = new CrystalFrontCoverHitsCollection(SensitiveDetectorName,collectionName[0]);
  if (fHCID<0)
  ...
  for (G4int iColumn=0 ; iColumn<36 ; iColumn++)
    for (G4int iRow=0 ; iRow<30 ; iRow++)
      {
	CrystalFrontCoverHit* hit = new CrystalFrontCoverHit();
...
G4bool CrystalFrontCoverSD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
  //20171031(start)
  ...
  // G4int columnNo = columnPhysical->GetCopyNo();//0~35(36) in total
  // //    G4cout<<"columnNo :"<<columnNo<<G4endl;
  // G4int hitID = 30*columnNo+rowNo;//0~1079(1080)
  // //    G4cout<<"hitID :"<<hitID<<G4endl;
  // //20180117(finish)

  CrystalFrontCoverHit* hit = (*fHitsCollection)[hitID];
  //CrystalFrontCoverHit* hit = new CrystalFrontCoverHit();
  //20171102(finish)
