...
G4ThreadLocal G4Allocator<FluxHit>* FluxHitAllocator;
...
FluxHit::FluxHit(G4int iCol,G4int iRow)
...
const FluxHit& FluxHit::operator=(const
                                    FluxHit &right)
{
    fColumnID = right.fColumnID;
    fRowID = right.fRowID;
...
int FluxHit::operator==(const FluxHit &right) const
{
...
const std::map<G4String,G4AttDef>* FluxHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("FluxHit",isNew);
...
std::vector<G4AttValue>* FluxHit::CreateAttValues() const
{
