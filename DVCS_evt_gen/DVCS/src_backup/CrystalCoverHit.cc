...
G4ThreadLocal G4Allocator<CrystalCoverHit>* CrystalCoverHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

CrystalCoverHit::CrystalCoverHit()\
...
CrystalCoverHit::CrystalCoverHit(G4int iCol,G4int iRow)
...
CrystalCoverHit::CrystalCoverHit(const CrystalCoverHit &right)
: G4VHit() {
...
const CrystalCoverHit& CrystalCoverHit::operator=(const
                                    CrystalCoverHit &right)
{
    fColumnID = right.fColumnID;
    fRowID = right.fRowID;
    fEdep = right.fEdep;
...
int CrystalCoverHit::operator==(const CrystalCoverHit &right) const
{
...
const std::map<G4String,G4AttDef>* CrystalCoverHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("CrystalCoverHit",isNew);
...
std::vector<G4AttValue>* CrystalCoverHit::CreateAttValues() const
{
