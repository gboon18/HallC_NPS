...
G4ThreadLocal G4Allocator<PMTcoverHit>* PMTcoverHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

PMTcoverHit::PMTcoverHit()\
...
PMTcoverHit::PMTcoverHit(G4int iCol,G4int iRow)
...
PMTcoverHit::PMTcoverHit(const PMTcoverHit &right)
: G4VHit() {
...
const PMTcoverHit& PMTcoverHit::operator=(const
                                    PMTcoverHit &right)
{
    fColumnID = right.fColumnID;
    fRowID = right.fRowID;
...
int PMTcoverHit::operator==(const PMTcoverHit &right) const
{
...
const std::map<G4String,G4AttDef>* PMTcoverHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("PMTcoverHit",isNew);
...
std::vector<G4AttValue>* PMTcoverHit::CreateAttValues() const
{
