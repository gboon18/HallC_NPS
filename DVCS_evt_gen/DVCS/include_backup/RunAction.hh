...
//20180425(start)
//const G4int MaxNtuple = 1080;//already declared in EventAction.hh
//20180425(finish)
...
private:
  ...
  //20180720(start)
  G4int    fIndex, fIndex2;//20180720 I have no idea why fIndex is not working
  //20180720(finish)

  //20180129(start)
  long fSeed1, fSeed2, fSeed3;//20180720 I have no idea why fSeed1 is not working
  //20180129(finish)
};
