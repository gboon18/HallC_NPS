...
#ifndef ChambWindSD_h
#define ChambWindSD_h 1
...
class ChambWindSD : public G4VSensitiveDetector
{    
public:
    ChambWindSD(G4String name);
    virtual ~ChambWindSD();
...
private:
    ChambWindHitsCollection* fHitsCollection;
    G4int fHCID;
};
