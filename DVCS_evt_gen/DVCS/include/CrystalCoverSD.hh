...
#ifndef CrystalCoverSD_h
#define CrystalCoverSD_h 1
...
class CrystalCoverSD : public G4VSensitiveDetector
{    
public:
    CrystalCoverSD(G4String name);
    virtual ~CrystalCoverSD();
    
    virtual void Initialize(G4HCofThisEvent*HCE);
    virtual G4bool ProcessHits(G4Step*aStep,G4TouchableHistory*ROhist);
    
private:
    CrystalCoverHitsCollection* fHitsCollection;
    G4int fHCID;
};
